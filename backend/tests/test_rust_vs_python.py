...
sys.path.insert(0, '.')
from backend.solver.mohr_coulomb import mohr_coulomb_yield as py_mc_yield
from backend.solver.mohr_coulomb import return_mapping_mohr_coulomb as py_mc_return
from backend.solver.hoek_brown import hoek_brown_yield as py_hb_yield
from backend.solver.hoek_brown import return_mapping_hoek_brown as py_hb_return
